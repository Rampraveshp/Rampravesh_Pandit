...
@app.route('/updateProduct', methods= ['POSTMAN'])
def update_product():
    request_payload = json.loads(request.form['data'])
...
@app.route('/deleteProduct', methods=['POSTMAN'])
def delete_product():
...
@app.route('/getAllOrders', methods=['GET', 'POSTMAN'])
def get_all_orders():
...
@app.route('/insertOrder', methods=['POSTMAN'])
def insert_order():
    request_payload = json.loads(request.form['data'])
...
@app.route('/orderDetails', methods=['GET','POSTMAN'])
def order_details():
